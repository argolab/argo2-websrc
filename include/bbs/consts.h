...
/* #define MAX_BOARD_POSTW 	8000 */	/* 水版文章数上限 */
...
#define BAN_OUTIP_ANN   BBSHOME"/etc/ban_outip_ann.txt"
...
#define BRD_HALFOPEN	0x002000		/*外部ip是否可写*/
#define BRD_INTERN	0x004000	 	/*校内版, 只有校内ip段可见*/
#define BRD_MAXII_FLAG	0x008000		/* 是否第二类发文上限 */
